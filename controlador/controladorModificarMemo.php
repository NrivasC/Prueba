	...
	<section class="full-box nav-lateral">
        ...
        //--------Consultamos el memo--------//
				...
				if(isset($_POST['Enviar'])){ // verificamos el formulario por el input escondido
					...
					if(($_POST['para'] != "") && ($_POST['asunto'] != "")&& ($_POST['descripción'] != "") &&  ($_POST['idMemo'] != "") && ($_POST['fecha'] != "")){
						...
						$memo= new memo($row1[7],$_POST['fecha'],null,null,null,null,$_POST['idMemo'],$para,$_POST['asunto'],$_POST['descripcion'],$de); // instanciamos
