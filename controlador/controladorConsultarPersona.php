				...
				<div class="col-12">
                    <p class="text-center" style="margin-top: 40px;">
                    	...
                    	if($_POST['Cédula'] != "" && $_POST['optConPer']=="1"){
							...
							echo"<a href='./controladorReportesPersona.php?codigo=".$codigo.'&opt='.$opt.'&depid='.$depid."' target='_blank' rel='snoopener noreferrer'>
							...
							echo"<a href='./controladorReportesPersona.php?codigo&opt=".$opt.'&depid='.$depid."' target='_blank' rel='snoopener noreferrer'>
                       		<button type='submit' class='btn btn-raised btn-danger' name='reporteG' id='reporte'><i class='fas fa-file-invoice fa-fw' ></i> &nbsp; REPORTE</button>
                    		</a>";
						}
